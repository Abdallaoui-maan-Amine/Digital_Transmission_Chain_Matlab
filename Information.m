...
% Last Modified by GUIDE v2.5 24-Jun-2020 18:57:20
...
% --- Executes on button press in page_principale.
function page_principale_Callback(hObject, eventdata, handles)
% hObject    handle to page_principale (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close(Information);
